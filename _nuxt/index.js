            ...
            [
              function () {
                ...
                return e("div", { staticClass: "footer" }, [
                  ...
                  e(
                    "a",
                    { attrs: { href: "https://telegra.ph", target: "_blank" } },
                    [this._v("Telegraph")]
                  ),
                  this._v(" 的图片上传工具\n"),
                ]);
          ...
          m = {
            ...
            methods: {
              ...
              uploadInputchange: function () {
                var t = this,
                  e = document.getElementById("upFiles").files;
                if (e.length > 0) {
                  t.status = "uploading";
                  t.uploadMultiple(e);
                }
              ...
              upload: function (t) {
                ...
                o.append("file", t),
                  r.a
                    ...
                    .then(function (t) {
                      200 === t.status
                        ? ((e.status = "done"), (e.imgUrl = location.origin + t.data[0].src))
                        : e.showError();
                    })
                    .catch(function () {
                      e.showError();
                  ...
                  (function (l) {
                    ...
                    i.append("file", t[l]),
                      r.a
                        ...
                        .then(function (t) {
                          if (200 === t.status) {
                            o.push(location.origin + t.data[0].src);
                            n++;
                            if (n === c) {
                              e.status = "done";
                              e.imgUrl = o.join("\n");
                ...
                function () {
                  ...
                  return o(
                    ...
                    [
                      o(
                        "div",
                        { staticClass: "wrapper", class: t.status },
                        [
                          o(
                            "div",
                            {
                            ...
                            [
                              ...
                              t._m(0),
                              t._v(" "),
                              o("div", { staticClass: "upload-btn-area" }, [
                                o("input", {
                                  attrs: {
            ...
            function () {
              ...
              return e("div", { staticClass: "container" }, [
                ...
                e("div", { staticClass: "main" }, [
                  e("div", { staticClass: "title" }, [this._v("Telegraph-Image")]),
                  this._v(" "),
                  e("Upload"),
                ], 1),
                this._v(" "),
